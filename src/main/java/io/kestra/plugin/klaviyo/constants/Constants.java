package io.kestra.plugin.klaviyo.constants;

public class Constants {
    public static final String PROFILE_URL = "https://a.klaviyo.com/api/profiles/";
    public static final String REVISION = "2025-07-15";

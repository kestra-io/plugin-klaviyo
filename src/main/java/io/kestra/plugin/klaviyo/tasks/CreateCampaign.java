        ...
        List<CreateCampaignRequest.CampaignMessageData> campaignMessageDataList = renderedMessages.stream().map(message -> {
            try {
                ...
                CreateCampaignRequest.Definition definition = CreateCampaignRequest.Definition.builder()
                    .channel(renderedDefinition.getChannel().toString())
                    .label(renderedDefinition.getLabel().toString())
                    .content(CreateCampaignRequest.Content.builder()
                        .subject(renderedContent.getSubject().toString())
                        .preview_text(renderedContent.getPreview_text().toString())
                        .from_email(renderedContent.getFrom_email().toString())
                        .from_label(renderedContent.getFrom_label().toString())
